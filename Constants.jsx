...
export const pages = ["Home", "Browse Jobs", "Pages", "Contact"];
...
export const JOBS = [
  {
    ...
    description: "As a Software Engineer, you will develop, test, and maintain software applications that drive our core services. You’ll work closely with a dynamic team, translating business needs into technical solutions and optimizing our system for performance.",
    responsibility: [
    ...
    benefits: "Health insurance, flexible working hours, remote work options, and professional development opportunities.",
  ...
  },
  {
    ...
    description: "We are seeking a creative UI/UX Designer who will be responsible for designing seamless and engaging user interfaces for web and mobile applications. You will collaborate with developers and product managers to create designs that enhance user experience.",
    responsibility: [
    ...
    benefits: "Comprehensive health coverage, annual bonus, stock options, and a creative work environment.",
  ...
  },
  {
    ...
    description: "As a Data Scientist, you will analyze large datasets to uncover trends and insights that will influence business decisions. You will work closely with product teams to implement machine learning models and predictive analytics solutions.",
    responsibility: [
    ...
    benefits: "Work from home, paid time off, wellness programs, and opportunities for continuing education.",
  ...
  },
  {
    ...
    description: "The Digital Marketing Manager will be responsible for developing and executing digital marketing strategies across various online platforms. You will work with a cross-functional team to drive traffic, enhance engagement, and grow our brand’s presence.",
    responsibility: [
    ...
    benefits: "Flexible working hours, health and dental insurance, team-building events, and performance-based bonuses.",
  ...
  },
  {
    ...
    description: "We are looking for an experienced Product Manager to lead the development and launch of innovative products. You will work with stakeholders to gather requirements, prioritize tasks, and ensure successful delivery of high-quality products.",
    responsibility: [
    ...
    benefits: "Competitive salary, health benefits, annual travel stipend, and opportunities for career growth.",
    salary: "€60,000 - €80,000 per year",
    vacancy: 2,
  ...
  },
  {
    ...
    description: "The DevOps Engineer will automate and optimize our software development process, ensuring efficient CI/CD pipelines and reliable deployment workflows. You will collaborate with developers to improve system scalability, performance, and security.",
    responsibility: [
    ...
    benefits: "Remote work flexibility, health and wellness programs, stock options, and annual performance bonuses.",
