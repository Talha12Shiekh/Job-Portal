...
export const GreenButton = ({
  ...
  return (
    ...
    >
      <CustomTypography text={text} fontWeight="bold" fontSize={"large"} />
    </Button>
  );
};
...
const Home = () => {
  ...
  return (
    <>
      <input type="file" accept="application/pdf" ref={inputRef} hidden />
      <Container
        component="section"
        disableGutters
        maxWidth={false}
          ...
          >
            <Grid size={{ lg: 7, md: 12 }} alignSelf={"center"}>
              ...
              <Typography
                ...
                mb={5}
              >
                Your Gateway to the Perfect Job—Connecting Talent with
                Opportunity
              </Typography>
              <GreenButton
